task step2 {
    ...
    command <<<
        ...
        echo "${pheno} /cromwell_root/${prefix}.${pheno}.loco.gz" > "${prefix}.${pheno}.pred.list"
        echo "${pheno} /cromwell_root/${prefix}.${pheno}.firth.gz" >"${prefix}.${pheno}.firth.list"
        ...
        --phenoFile ${cov_pheno} \
        --phenoColList ${pheno} \
        --pred ${prefix}.${pheno}.pred.list \
        ${if is_binary then "--use-null-firth ${prefix}.${pheno}.firth.list" else ""} \
        --bsize ${bsize} \
        --threads $n_cpu \
        --gz \
        --out ${prefix} \
